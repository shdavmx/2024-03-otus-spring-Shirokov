...
public class ResultServiceImplTest {
    ...
    @BeforeEach
    void init() {
        testStudent = new Student("testName", "testLastName");
    ...
    void shouldDisplaySuccessMessage() {
        String expectedMessage = "Congratulation! You passed test!";
        ...
        Mockito.doNothing().when(ioService).printLine(message.capture());
