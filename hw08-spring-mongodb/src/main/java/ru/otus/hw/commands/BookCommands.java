...
public class BookCommands {
    ...
    @ShellMethod(value = "Find all books by author id", key = "abbaid")
    public String findAllBooksByAuthorId(String authorId) {
        return bookService.findAllByAuthorId(authorId).stream()
                .map(bookConverter::bookToString)
                .collect(Collectors.joining("," + System.lineSeparator()));
    }
