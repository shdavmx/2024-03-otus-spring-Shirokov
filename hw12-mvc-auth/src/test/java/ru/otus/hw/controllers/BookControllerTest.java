...
public class BookControllerTest {
    ...
    @DisplayName("should return 302 for get all books")
    @Test
    public void shouldReturn302ForGetAllBooks() throws Exception {
        mvc.perform(get("/books"))
    ...
    @DisplayName("should return 302 for delete book by id")
    @Test
    public void shouldReturn302ForDeleteBookById() throws Exception {
        mvc.perform(post("/books/delete?id=" + TEST_BOOK_ID))
                .andExpect(status().isFound());
    }
    ...
    @DisplayName("should return 302 for get book info")
    @Test
    public void shouldReturn302ForGetBookInfo() throws Exception {
        mvc.perform(get("/books/info/"+TEST_BOOK_ID))
                .andExpect(status().isFound());
    }
    ...
    @DisplayName("should return 302 for get book to edit")
    @Test
    public void shouldReturn302ForGetBookToEdit() throws Exception {
        mvc.perform(get("/books/edit/"+TEST_BOOK_ID))
                .andExpect(status().isFound());
    }
    ...
    @DisplayName("should return 302 for save book")
    @Test
    public void shouldReturn302ForSaveBook() throws Exception {
        mvc.perform(post("/books/edit")
                        .param("id", testBooks.get(0).getId())
                        .param("title", testBooks.get(0).getTitle())
                        .param("authorId", testBooks.get(0).getAuthor().getId())
