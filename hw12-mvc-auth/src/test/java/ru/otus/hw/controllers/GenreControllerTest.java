...
public class GenreControllerTest {
    ...
    @DisplayName("should return 302 for get all genres")
    @Test
    public void shouldReturn302ForGetAllGenres() throws Exception {
        mvc.perform(get("/genres"))
    ...
    @DisplayName("should return 302 for delete genre by id")
    @Test
    public void shouldReturn302ForDeleteGenreById() throws Exception {
        mvc.perform(post("/genres/delete?id=" + TEST_GENRE_ID))
                .andExpect(status().isFound());
    }
    ...
    @DisplayName("should return 302 for get genre to edit")
    @Test
    public void shouldReturn302ForGetGenreToEdit() throws Exception {
        mvc.perform(get("/genres/edit/"+TEST_GENRE_ID))
                .andExpect(status().isFound());
    }
    ...
    @DisplayName("should return 302 for save genre")
    @Test
    public void shouldReturn302ForSaveGenre() throws Exception {
        mvc.perform(post("/genres/edit")
                        .param("id", testGenres.get(0).getId())
                        .param("name", testGenres.get(0).getName()))
                .andExpect(status().isFound());
